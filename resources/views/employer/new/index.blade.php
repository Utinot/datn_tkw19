                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <h5>
                                                @if (Carbon::parse($item->end_job_time)->format('d') - Carbon::parse(Carbon::now())->format('d') <= 0) {{-- {{ route('employer.changestatus', $item->id) }} --}} Hết hạn @else {{ Carbon::parse($item->end_job_time)->format('d') - Carbon::parse(Carbon::now())->format('d') }} ngày @endif @else @if ($all_day - Carbon::parse($item->job_time)->format('d') +
                                                    ($mon - ($mon - Carbon::parse($item->end_job_time)->format('d'))) <= 0) <h5>
                                        ...
                                        <td><a href="{{ route('employer.new.edit', $item->id) }}" type="button" class="btn btn-primary btn-action-create">
